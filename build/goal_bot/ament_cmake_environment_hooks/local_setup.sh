...
: ${AMENT_CURRENT_PREFIX:="/robot_ws/src/goal_bot/install/goal_bot"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/goal_bot/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/goal_bot/environment/path.sh"
